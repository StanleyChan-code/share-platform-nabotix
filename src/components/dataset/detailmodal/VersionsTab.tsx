                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                            <div className="flex items-start gap-3">
                                                <div
                                                    className="flex-shrink-0 h-6 w-6 rounded-full bg-blue-200 text-blue-800 flex items-center justify-center font-medium">
                                    ...
                                    <CardContent className="p-6">
                                        ...
                                        <div
                                            ...
                                            <div className="flex items-start gap-4 flex-1">
                                                ...
                                                {/* 发布时间 */}
                                                <div
                                                    className="flex items-center gap-2 text-sm text-muted-foreground bg-muted/20 rounded-lg px-3 py-2">
                                        ...
                                        <div className="border-t pt-4">
                                            ...
                                            {hasDescription ? (
                                                ...
                                                <div
                                                    className="flex items-center justify-center gap-2 text-sm text-muted-foreground bg-muted/20 rounded-lg p-6">
                                                ...
                                                <div className="mb-4">
                                                    ...
                                                    <div className="bg-muted/20 rounded-lg p-4">
                                                        <div className="flex flex-col gap-2">
                                                            <div className="flex justify-between items-center">
                                                                <span
                                                                    className="text-sm text-muted-foreground">审核状态</span>
                                                                <Badge
                                                            ...
                                                            {version.institutionApprovedAt && (
                                                                <div className="flex justify-between items-center">
                                                                    <span
                                                                        className="text-sm text-muted-foreground">审核时间</span>
                                                                    <span
                                                                        className="text-sm">{formatDateTime(new Date(version.institutionApprovedAt))}</span>
                                                                </div>
                                                            )}
                                                            {version.institutionReviewer && (
                                                                <div className="flex justify-between items-center">
                                                                    <span
                                                                        className="text-sm text-muted-foreground">审核员</span>
                                                                    <span
                                                                        className="text-sm">{version.institutionReviewer.realName}</span>
                                                                </div>
                                                            )}
                                                            {!version.institutionApproved && version.institutionRejectReason && (
                                                                <div className="mt-2">
                                                                    <span
                                                                        className="text-sm text-muted-foreground block mb-1">拒绝原因</span>
                                                                    <span
                                                                        className="text-sm text-red-600 whitespace-pre-wrap">{version.institutionRejectReason}</span>
                                                                </div>
                                                            )}
                                                        </div>
                                                    </div>
                                                            ...
                                                            {version.approvedAt && (
                                                                <div className="flex justify-between items-center">
                                                                    <span
                                                                        className="text-sm text-muted-foreground">审核时间</span>
                                                                    <span
                                                                        className="text-sm">{formatDateTime(new Date(version.approvedAt))}</span>
                                                                </div>
                                                            )}
                                                            {version.supervisor && (
                                                                <div className="flex justify-between items-center">
                                                                    <span
                                                                        className="text-sm text-muted-foreground">审核员</span>
                                                                    <span
                                                                        className="text-sm">{version.supervisor.realName}</span>
                                                                </div>
                                                            )}
                                                            {!version.approved && version.rejectReason && (
                                                                <div className="mt-2">
                                                                    <span
                                                                        className="text-sm text-muted-foreground block mb-1">拒绝原因</span>
                                                                    <span
                                                                        className="text-sm text-red-600 whitespace-pre-wrap">{version.rejectReason}</span>
                                                                </div>
                                                            )}
                                                        </div>
                                                    </div>
