                              ...
                              <div className="space-y-2 bg-muted/20 rounded-lg p-2">
                                <div className="flex items-center justify-between">
                                  <div className="flex items-center gap-1">
                                    ...
                                    <span className="text-xs text-muted-foreground whitespace-nowrap">记录</span>
                                  </div>
                              ...
                              {(version.recordCount || 0).toLocaleString()}
                                ...
                                <div className="flex items-center justify-between">
                                  <div className="flex items-center gap-1">
                                    ...
                                    <span className="text-xs text-muted-foreground whitespace-nowrap">变量</span>
                                  </div>
                                  <span className="font-semibold text-sm whitespace-nowrap">
                            ...
                            <TableCell className="py-4 align-top">
                              <div className="max-w-full">
                                {hasDescription ? (
                                    ...
                                    <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground bg-muted/20 rounded-lg p-3 h-20">
