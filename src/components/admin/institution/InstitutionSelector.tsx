...
import {Building2, ChevronsUpDown, Check, X, Building} from "lucide-react";
          ...
          {value && value.length > 0 && allowMultiple && (
              <div className="flex flex-wrap gap-2">
                {selectedInstitutions.map((institution) => (
                    <Badge key={institution.id} variant="secondary"
                           className="gap-1 text-sm whitespace-nowrap overflow-hidden">
                ...
                <PopoverTrigger asChild>
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <ChevronsUpDown className="h-4 w-4 opacity-50 cursor-pointer hover:opacity-100"
                                            style={{pointerEvents: 'all'}}/>
                        </div>
                    </Button>
                </PopoverTrigger>
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col flex-1">
                                            <div className="flex items-center justify-between">
                                              <span
                                                  className={`font-medium ${disableUnverified && !institution.verified ? 'text-muted-foreground' : ''}`}>
                                                {institution.type && (
